...
- **TA 0.9 coding — all four review-clean; awaiting Dean's push/PR decision.** Four Type 3 plans
  ...
  `ta-veto-liveness` (D, round-2 **APPROVE**, tip `7e931ccf`, **not yet pushed**). **Remaining
  action = Dean's decision:** push D to origin, and whether/when to open PRs for A/A′/C/D. No
  coder work outstanding on any of the four. (D detail: coder's per-tuple
