...
| analyzer-metric-proposal | #1444 | **OPEN** 2026-07-21 — docs-only external proposal (metric-based analyzer interface: `(demand, target)` per item, KEDA/HPA-symmetric). `docs/proposals/analyzer-metric-interface.md`, Status: Draft, reviewer ev-shindin. No tracking issue yet. Worktree kept. Internal draft: [`planning/analyzer-metric-interface-proposal.md`](../planning/analyzer-metric-interface-proposal.md). | `39a83d0b` |
