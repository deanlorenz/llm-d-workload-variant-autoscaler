...
| 9 | Clean recapture campaign — warmup + log-capture fix + exploratory instrumentation | 🆕 SCOPED 2026-08-16, not yet executed — [`ta-pokprod-clean-recapture-plan.md`](ta-pokprod-clean-recapture-plan.md) |
