...
| Per-request TTFT/output-size estimation for viz panels 1a/1b | ✅ **BUILT+VERIFIED 2026-08-16 on the 1 example run — 2 findings open (rotation-truncated trace, unexplained stage-4 rate anomaly), neither blocking, viz can review output** | [[D-55]], [[D-57]], [[D-59]], [`envoy-per-request-recovery-tool-plan.md`](envoy-per-request-recovery-tool-plan.md) |
