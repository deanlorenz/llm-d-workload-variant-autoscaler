...
| Per-request TTFT/output-size estimation for viz panels 1a/1b | 🔵 **1 of 3 findings FIXED 2026-08-16 (boundary-spike was a real indexing bug, traced+fixed, `c0f4d5f3`) — 2 open (rotation-truncated trace, unexplained stage-4 rate anomaly), neither blocking, viz can review** | [[D-55]], [[D-57]], [[D-59]], [[D-60]], [[D-62]], [`envoy-per-request-recovery-tool-plan.md`](envoy-per-request-recovery-tool-plan.md) |
