...
| Per-request TTFT/output-size estimation for viz panels 1a/1b — design done, build handed to coder | 🔵 **IN PROGRESS 2026-08-15 — scoped to 1 example run first** | [[D-55]], [[D-57]], [`envoy-per-request-recovery-tool-plan.md`](envoy-per-request-recovery-tool-plan.md) |
