...
| Doc-coverage gap: 5 more scratch tools never promoted, undocumented (`verify_decision_rule.py`, `server_token_truth.py`, `stage_table.py`, `stage_vs_replicas.py`, `watch_pvc_space.sh`) | ✅ **DRAFT CLEANUP PLAN WRITTEN 2026-08-15 — recommendation (4 DEFERRED-as-pattern, 1 promote-as-is), Dean's classification call not yet made** | [[D-51]], [`pokprod-scratch-tools-doc-coverage-cleanup-plan.md`](pokprod-scratch-tools-doc-coverage-cleanup-plan.md) |
